...
/*00*/  ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, GATE1, GATE1, GATE1, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2,
/*01*/  EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2,
/*02*/  EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EDGE1, ROOF2,
/*03*/  EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, SIGN1, EDGE1, EDGE1, ROOF2, EDGE1, EDGE1, SIGN1, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EDGE1, ROOF2, ROOF2,
/*04*/  EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, BRICK, BRICK, BRICK, ROOF2, BRICK, BRICK, BRICK, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, ROOF2,
/*05*/  EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, ROCK3, ROOF2, ROOF2, ROOF2, ROCK4, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, ROOF2,
/*06*/  EMPTY, EMPTY, EMPTY, GRASS, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
/*07*/  EMPTY, EMPTY, EMPTY, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
/*08*/  EMPTY, EMPTY, EMPTY, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
/*09*/  EMPTY, EMPTY, EMPTY, ROOF2, GRASS, EMPTY, EMPTY, EMPTY, EMPTY, EDGE1, EDGE1, SIGN1, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EDGE1, EDGE1, EDGE1, SIGN1,
/*10*/  EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, GRASS, EMPTY, EMPTY, EMPTY, BRICK, BRICK, BRICK, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, GRASS, EMPTY, EMPTY, EMPTY, EMPTY, GRASS, EMPTY, EMPTY, EMPTY, EMPTY, BRICK, BRICK, BRICK, BRICK,
/*11*/  EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, ROOF2, ROCK2, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, GRASS, ROOF2, GRASS, EMPTY, EMPTY, EMPTY, ROOF2, GRASS, EMPTY, EMPTY, EMPTY, ROOF2, ROCK6, ROOF2, ROOF2,
/*12*/  EDGE1, EDGE1, SIGN1, ROOF2, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EDGE1, EDGE1, SIGN1, ROOF2, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, ROOF2, ROOF2, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
/*13*/  BRICK, BRICK, BRICK, ROOF2, ROOF2, ROOF2, GRASS, SIGN1, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, BRICK, BRICK, BRICK, ROOF2, ROOF2, ROOF2, WATER, WATER, WATER, ROOF2, ROOF2, GRASS, GRASS, GRASS, PLAT1, WATER, WATER, WATER,
/*14*/  ROOF2, ROCK1, ROOF2, ROOF2, ROOF2, ROOF2, ROOF2, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, ROOF2, ROCK5, ROOF2, ROOF2, ROOF2, ROOF2, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1, PLAT1,
};
